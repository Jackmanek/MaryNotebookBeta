...
- **🗄️ Base de datos Oracle Cloud free (para producción) o Docker ORACLE-DATA (para desarrollo)**
...
1. **🔄 Clona el repositorio**:
   ...
   cd MaryNotebook
   ```
2. **⚙️ Configura `application.properties` para tu entorno.**
...
2. **⚙️ Configura `application-prod.properties` para tu entorno de producción.**
...
6. **▶️ Ejecuta la aplicación dentro del contenedor:**
